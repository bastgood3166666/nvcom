...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.15.164"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 12986;
pub const RELAY_PORT: i32 = 12987;
pub const WS_RENDEZVOUS_PORT: i32 =12988;
pub const WS_RELAY_PORT: i32 = 12989;
