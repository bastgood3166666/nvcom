...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.34.84"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 13886;
pub const RELAY_PORT: i32 = 13887;
pub const WS_RENDEZVOUS_PORT: i32 =13888;
pub const WS_RELAY_PORT: i32 = 13889;
