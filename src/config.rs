...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("亿宝连.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.125.216.24"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 11326;
pub const RELAY_PORT: i32 = 11327;
pub const WS_RENDEZVOUS_PORT: i32 =11328;
pub const WS_RELAY_PORT: i32 = 11329;
