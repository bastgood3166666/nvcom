...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("联会通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.45.124.50"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 12686;
pub const RELAY_PORT: i32 = 12687;
pub const WS_RENDEZVOUS_PORT: i32 =12688;
pub const WS_RELAY_PORT: i32 = 12689;
