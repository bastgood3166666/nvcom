...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.45.124.54"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 13586;
pub const RELAY_PORT: i32 = 13587;
pub const WS_RENDEZVOUS_PORT: i32 =13588;
pub const WS_RELAY_PORT: i32 = 13589;
