...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.15.166"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 13486;
pub const RELAY_PORT: i32 = 13487;
pub const WS_RENDEZVOUS_PORT: i32 =13488;
pub const WS_RELAY_PORT: i32 = 13489;
