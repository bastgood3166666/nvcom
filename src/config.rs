...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("连会通".to_owned());
...
pub const RENDEZVOUS_PORT: i32 = 12086;
pub const RELAY_PORT: i32 = 12087;
pub const WS_RENDEZVOUS_PORT: i32 =12088;
pub const WS_RELAY_PORT: i32 = 12089;
