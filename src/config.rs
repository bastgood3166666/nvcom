...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.125.216.216"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 10926;
pub const RELAY_PORT: i32 = 10927;
pub const WS_RENDEZVOUS_PORT: i32 =10928;
pub const WS_RELAY_PORT: i32 = 10929;
