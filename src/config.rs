...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.45.124.53"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 13386;
pub const RELAY_PORT: i32 = 13387;
pub const WS_RENDEZVOUS_PORT: i32 =13388;
pub const WS_RELAY_PORT: i32 = 13389;
