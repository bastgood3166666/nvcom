...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("实议宝.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["39.97.161.128"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56336;
pub const RELAY_PORT: i32 = 56337;
pub const WS_RENDEZVOUS_PORT: i32 =56338;
pub const WS_RELAY_PORT: i32 = 56339;
