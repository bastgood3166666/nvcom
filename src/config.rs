...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("议密宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.176.26"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 13786;
pub const RELAY_PORT: i32 = 13787;
pub const WS_RENDEZVOUS_PORT: i32 =13788;
pub const WS_RELAY_PORT: i32 = 13789;
